            ...
            <div className="row">
                <div className="col-md-6 col-12 left">
                    <div className="warna"></div>
                        <img src="assets/img/logo/logo-alterra-academy-plain@2x.png" className="logo1"/>
                </div>
                <div className="col-md-6 col-12 right">
                    ...
                    <div className="input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text" id="basic-addon1"><img src="assets/img/ico/ico-user.png"/></span>
                        </div>
                    ...
                    <div className="input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text" id="basic-addon1"><img src="assets/img/ico/ico-email.png"/></span>
                        </div>
                    ...
                    <div className="input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text" id="basic-addon1"><img src="assets/img/ico/ico-phone.png"/></span>
                        </div>
